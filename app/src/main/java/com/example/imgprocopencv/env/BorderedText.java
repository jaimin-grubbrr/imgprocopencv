...
package com.example.imgprocopencv.env;
...
public class BorderedText {
  ...
  public void drawText(
          final Canvas canvas, final float posX, final float posY, final String text, Paint bgPaint, RectF rectF) {
...
//    canvas.drawRect(posX, (posY + (int) (textSize)), (posX + (int) (width)), posY, paint);
    canvas.drawRect(posX-5, (posY + (int) (textSize))+20 , (0 + rectF.right), posY, paint);

    canvas.drawText(text, posX+3, (posY + textSize)+5, interiorPaint);
  }
